...
<html>
  ...
  <body>
      <form action="#" class="login-form">
		  ...
		  <br>
		  <br>
		  <p class="success"> STORE 등록이 완료되었습니다. <br><br> MY STORE로 이동하여 MY TABLE을 이용해 보세요.</p>  
	     
		 <br>
         <div class="find-btn">
		    <button type="button" class="btn" onClick="location.href='storeMypage'">MY STORE 가기</button>
		 </div>
